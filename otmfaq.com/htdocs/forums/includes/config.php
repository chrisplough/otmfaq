...
$config['Database']['dbname'] = 'otmfaq_vb';
...
$config['Database']['technicalemail'] = 'admin@otmfaq.com';
...
$config['MasterServer']['servername'] = 'otmfaq-prod-20131016.cgjdhx9db4yn.us-east-1.rds.amazonaws.com';
$config['MasterServer']['port'] = 3306;

	//	****** MASTER DATABASE USERNAME & PASSWORD ******
	//	This is the username and password you use to access MySQL.
	//	These must be obtained through your webhost.
$config['MasterServer']['username'] = 'vbdba';
$config['MasterServer']['password'] = 'wy46GCqcMe92';
