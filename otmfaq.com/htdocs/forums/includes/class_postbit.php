...
*
* @package 		vBulletin
* @version		$Revision: 41258 $
* @date 		$Date: 2010-12-29 15:31:35 -0800 (Wed, 29 Dec 2010) $
*
*/
...
class vB_Postbit
{
	...
	*/
	function construct_postbit(&$post)
	{
		...
		{
			$post['message_plain'] = strip_bbcode($post['pagetext'], false, false, true, false, true);
