...
class ImpExDatabase extends ImpExFunction
{
	...
	*/
	...
	function get_subscription_ids(&$Db_object, &$databasetype, &$tableprefix, $do_int_val = false)
	{
		$return_array = array();
		...
		switch ($databasetype)
		{
			...
			case 'mysql':
			{
				...
				{
					$return_array["$user[importsubscriptionid]"] = $user['subscriptionid'];
				}
	...
	*/
	function import_smilie(&$Db_object, &$databasetype, &$tableprefix)
	{
		switch ($databasetype)
		{
			...
			case 'mysql':
			{
				// TODO: This must be in the settings some where
	...
	function import_phrase(&$Db_object, &$databasetype, &$tableprefix)
	{
		switch ($databasetype)
		{
			case 'mysql':
			{
				...
				if(impexdebug) {echo  "<h1>'" . $this->get_value('mandatory','varname') . "'</h1>"; }
...
|| # CVS: $RCSfile: ImpExDatabase_360.php,v $ - $Revision: 1.19 $
|| ####################################################################
\*======================================================================*/
?>
