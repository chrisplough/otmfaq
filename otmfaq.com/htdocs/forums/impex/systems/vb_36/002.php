...
class vb_36_002 extends vb_36_000
{
	...
	function resume(&$sessionobject, &$displayobject, &$Db_target, &$Db_source)
	{
		...
		if ($associate_users == 1)
		{
			...
			$userarray = $this->get_details($Db_source, $source_database_type, $source_table_prefix, $associate_start_at, $associate_per_page, 'user', 'userid');
...
|| # CVS: $RCSfile: 002.php,v $ - $Revision: 1.2 $
|| ####################################################################
\*======================================================================*/
?>
