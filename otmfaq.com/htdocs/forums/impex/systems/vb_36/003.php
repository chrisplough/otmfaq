...
class vb_36_003 extends vb_36_000
{
	...
	function resume(&$sessionobject, &$displayobject, &$Db_target, &$Db_source)
	{
		...
		foreach ($usergroup_array as $usergroup_id => $usergroup_details)
		{
			...
			$try->set_value('nonmandatory', 'signaturepermissions',	$usergroup_details['']);
			$try->set_value('nonmandatory', 'sigpicmaxwidth',		$usergroup_details['']);
			$try->set_value('nonmandatory', 'sigpicmaxheight',		$usergroup_details['']);
			$try->set_value('nonmandatory', 'sigpicmaxsize',		$usergroup_details['']);
			$try->set_value('nonmandatory', 'sigmaximages',			$usergroup_details['']);
			$try->set_value('nonmandatory', 'sigmaxsizebbcode',		$usergroup_details['']);
			$try->set_value('nonmandatory', 'sigmaxchars',			$usergroup_details['']);
			$try->set_value('nonmandatory', 'sigmaxrawchars',		$usergroup_details['']);
			$try->set_value('nonmandatory', 'sigmaxlines',			$usergroup_details['']);
