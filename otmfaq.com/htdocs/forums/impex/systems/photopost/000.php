...
class photopost_000 extends ImpExModule
{
	...
	*/
	var $_valid_tables = array (
		...
		'ipcache', 'iponline', 'laston', 'notify', 'perpage', 'photos', 'settings', 'sort',
		'sortmemb', 'user', 'usergroups', 'users'
	);
	...
	*/
	function get_photopost_members_list(&$Db_object, &$databasetype, &$tableprefix, &$start, &$per_page)
	{
		...
		if (empty($per_page) OR $this->check_table($DB_object, $database_type, $table_prefix, 'user') ){return $return_array; }
