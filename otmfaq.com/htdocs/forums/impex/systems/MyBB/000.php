...
class MyBB_000 extends ImpExModule
{
	...
	*/
	var $_valid_tables = array (
		...
		'banned', 'events', 'favorites', 'forumpermissions', 'forums', 'forumsubscriptions', 'helpdocs', 'helpsections', 'icons',
		'moderatorlog', 'moderators', 'polls', 'pollvotes', 'posts', 'privatemessages', 'profilefields', 'regimages',
		'reportedposts', 'reputation', 'searchlog', 'settinggroups', 'settings', 'smilies', 'templates',
		'templatesets', 'themes', 'threadratings', 'threads', 'threadsread', 'userfields', 'usergroups', 'users', 'usertitles'
	);
