...
class ASPPlayground_000 extends ImpExModule
{
	...
	*/
	var $_valid_tables = array (
		'address', 'addressgroup', 'Announcement', 'Category', 'Colorscheme', 'Config', 'CSS', 'DBHeaderFooter', 'Forums',
		'GroupMember', 'Members', 'Messages', 'Moderator', 'PMFolder', 'PMreceive', 'PMsg', 'Poll', 'PollLog', 'PrivateUser',
		'Ranking', 'RateTrack', 'Revision', 'Session', 'Srvmsg', 'Subscription', 'upfile', 'UserGroup'
	);
