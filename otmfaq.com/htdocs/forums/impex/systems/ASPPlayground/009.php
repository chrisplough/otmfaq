...
class ASPPlayground_009 extends ASPPlayground_000
{
	...
	function resume(&$sessionobject, &$displayobject, &$Db_target, &$Db_source)
	{
		...
		{
			if(!$pm_to_id = $username_to_ids_array["$pm[sentto]"])
			{
			...
			if($vB_pm_text->is_valid())
			{
				...
				if($pm_text_id)
				{
					...
					if($vB_pm_text->is_valid())
					{
						...
						{
							$displayobject->display_now('<br /><span class="isucc"><b>' . $vB_pm_text->how_complete() . '%,</b></span> Imported from : <b>' . $user_name_array[$pm['fromid']] . '</b> , to : <b>' . $pm['sentto'] . '</b>');
...
|| # CVS: $RCSfile: 009.php,v $ - $Revision: 1.5 $
|| ####################################################################
\*======================================================================*/
?>
