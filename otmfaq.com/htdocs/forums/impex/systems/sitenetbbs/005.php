...
class sitenetbbs_005 extends sitenetbbs_000
{
	...
	function resume(&$sessionobject, &$displayobject, &$Db_target, &$Db_source)
	{
		...
		$user_ids_array = $this->get_username_to_ids($Db_target, $target_database_type, $target_table_prefix);
		...
		foreach ($thread_array as $thread_id => $thread_details)
		{
			...
			*/
			...
			$try->set_value('nonmandatory', 'postuserid',		$user_ids_array[$thread_details[1]]);
