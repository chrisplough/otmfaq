...
class eve_009 extends eve_000
{
	...
	function resume(&$sessionobject, &$displayobject, &$Db_target, &$Db_source)
	{
		...
		foreach ($pmtext_array as $pmtext_id => $pm_text)
		{
			...
			$vB_pm_text->set_value('nonmandatory', 'dateline',		strtotime($pm_text['TOPIC_DATETIME_POSTED']));
			...
			if($pm_text_id)
			{
				$vB_pm = (phpversion() < '5' ? $vB_pm_object : clone($vB_pm_object));
...
|| # CVS: $RCSfile: 009.php,v $ - $Revision: 1.23 $
|| ####################################################################
\*======================================================================*/
?>
