...
class ubb_classic_011 extends ubb_classic_000
{
	...
	function resume(&$sessionobject, &$displayobject, &$Db_target, &$Db_source)
	{
		...
		foreach ($poll_array as $name => $filename)
		{
			...
			#$vb_threadid = $this->get_forum_thread_id($Db_target, $target_database_type, $target_table_prefix, intval($details['topic']), intval($details['forum']));
			$vb_threadid = $vb_thread_ids[intval($details['forum'])][intval($details['topic'])];
...
|| # CVS: $RCSfile: 011.php,v $ - $Revision: 1.19 $
|| ####################################################################
\*======================================================================*/
?>
