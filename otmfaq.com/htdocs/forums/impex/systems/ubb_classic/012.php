	...
	function resume(&$sessionobject, &$displayobject, &$Db_target, &$Db_source)
	{
		...
		foreach ($mod_array as $forumid => $user_array)
		{
			foreach($user_array AS $userid)
			{
				...
				$try->set_value('mandatory', 'userid',				$user_ids_array[$userid]);
				...
				if($try->is_valid())
				{
					...
					{
						$displayobject->display_now("<br /><span class=\"isucc\"><b>" . $try->how_complete() . "%</b></span> :: " . $user_name_array[$userid]);
						flush;
...
|| # CVS: $RCSfile: 012.php,v $ - $Revision: 1.21 $
|| ####################################################################
\*======================================================================*/
?>
