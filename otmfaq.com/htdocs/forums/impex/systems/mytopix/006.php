...
class mytopix_006 extends mytopix_000
{
	...
	function resume(&$sessionobject, &$displayobject, &$Db_target, &$Db_source)
	{
		...
		foreach ($thread_array as $thread_id => $thread_details)
		{
			...
			// TODO: Check this
			#$try->set_value('nonmandatory', 'open',			$thread_details['topics_state']);
			$try->set_value('nonmandatory', 'open',				'1');
			$try->set_value('nonmandatory', 'visible',			iif($thread_details['topics_hidden'],0,1));
...
|| # CVS: $RCSfile: 006.php,v $ - $Revision: 1.3 $
|| ####################################################################
\*======================================================================*/
?>
