...
class ubb_threads_006 extends ubb_threads_000
{
	...
	function resume(&$sessionobject, &$displayobject, &$Db_target, &$Db_source)
	{
		...
		$usernames_array	= $this->get_username($Db_target, $target_database_type, $target_table_prefix);
		...
		foreach ($thread_array as $thread_id => $thread_details)
		{
			...
			$try->set_value('nonmandatory', 'postusername',		$usernames_array["$thread_details[B_PosterId]"]);
			$try->set_value('nonmandatory', 'postuserid',		$user_ids_array["$thread_details[B_PosterId]"]);
			$try->set_value('nonmandatory', 'lastposter',		$user_ids_array["$thread_details[LastPosterId]"]);
...
|| # CVS: $RCSfile: 006.php,v $ - $Revision: 1.7 $
|| ####################################################################
\*======================================================================*/
?>
