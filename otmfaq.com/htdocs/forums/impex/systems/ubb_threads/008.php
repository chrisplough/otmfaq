...
class ubb_threads_008 extends ubb_threads_000
{
	...
	function resume(&$sessionobject, &$displayobject, &$Db_target, &$Db_source)
	{
		...
		{
			$poll_options 	= $this->get_ubb_threads_poll_options($Db_source, $source_database_type, $source_table_prefix, $poll_id);
			...
			foreach($poll_options as $id => $data)
			{
				...
				$votes		.=  $this->get_ubb_threads_poll_votes($Db_source, $source_database_type, $source_table_prefix, $data['P_OptionNum']) . '|||';
...
|| # CVS: $RCSfile: 008.php,v $ - $Revision: 1.6 $
|| ####################################################################
\*======================================================================*/
?>
