...
class ubb_threads_007 extends ubb_threads_000
{
	...
	function resume(&$sessionobject, &$displayobject, &$Db_target, &$Db_source)
	{
		...
		foreach ($post_array as $post_id => $post_details)
		{
			...
			// Mandatory
			$try->set_value('mandatory', 'threadid',			$thread_ids_array["$post_details[B_Main]"]);
			$try->set_value('mandatory', 'userid',				$user_ids_array["$post_details[B_PosterId]"]);
			...
			$try->set_value('nonmandatory', 'username',			$usernames_array["$post_details[B_PosterId]"]);
...
|| # CVS: $RCSfile: 007.php,v $ - $Revision: 1.12 $
|| ####################################################################
\*======================================================================*/
?>
