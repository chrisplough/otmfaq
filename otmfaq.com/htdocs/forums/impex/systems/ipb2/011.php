...
class ipb2_011 extends ipb2_000
{
	...
	function resume(&$sessionobject, &$displayobject, &$Db_target, &$Db_source)
	{
		...
		foreach ($attachment_array as $attachment_id => $attachment_details)
		{
			...
			if(!is_file($dir . '/' . $attachment_details['attach_location']))
			{
			...
			$file = $this->vb_file_get_contents( $dir . '/' . $attachment_details['attach_location']);
...
|| # CVS: $RCSfile: 011.php,v $ - $Revision: 1.6 $
|| ####################################################################
\*======================================================================*/
?>
