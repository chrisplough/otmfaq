...
class ldu_000 extends ImpExModule
{
	...
	* @var    array
	*/
	var $_modulestring 	= 'Neocrome - LDU';
	...
	*/
	var $_valid_tables = array (
		'banlist', 'cache', 'com', 'config', 'eventp', 'events', 'forum_posts', 'forum_sections', 'forum_topics', 'groups', 'groups_users',
		'indblocker', 'journals', 'levels', 'links', 'logger', 'moderation', 'moderation_warnings', 'news', 'online', 'pages', 'pfs',
		'pfs_folders', 'plugin_silencer', 'plugins', 'pm', 'polls', 'polls_options', 'polls_voters', 'rated', 'ratings', 'referers',
		'rights', 'smilies', 'stats', 'structure', 'users'
	);
