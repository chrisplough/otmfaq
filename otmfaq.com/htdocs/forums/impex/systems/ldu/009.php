		...
		foreach ($poll_array as $poll_id => $poll_details)
		{
			...
			if($try->is_valid())
			{
				...
				else
				{
					...
					$displayobject->display_now("<br />{$impex_phrases['failed']} :: {$displayobject->phrases['poll_not_imported']}");
				}
			}
			else
			{
...
|| # CVS: $RCSfile: 009.php,v $ - $Revision: 1.1 $
|| ####################################################################
\*======================================================================*/
?>
